...
public class Util {
	...
	/**
	 * Returns the bounding box of the points under the given affine transformation.
	...
	/**
	 * If x is between xMin and xMax, then return x; 
	 * if x is less than xMin, then return xMin; 
	 * if x is greater than xMax, then return xMax.
