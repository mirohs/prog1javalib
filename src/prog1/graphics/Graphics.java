...
/**
 * Static graphics factory methods. Most methods create {@code Image} objects.
 * Images may be combined to form other images. Import as:<br>
 * {@code import prog1.graphics.Graphics.*;}
 *
...
public class Graphics {
    ...
    /**
     * This class is meant to be used in a way.
     * @param app
     */
    protected Graphics(ApplicationBase app) {
        this.app = app;
    }
     ...
     * @return the circle
     */
    public Image circle(double radius, Color fillColor) {
        return new Circle(app, radius, fillColor, null);
    }
     ...
     * @return the circle
     */
    public Image circle(double radius, Pen pen) {
        return new Circle(app, radius, null, pen);
    }
     ...
     * @return the circle
     */
    public Image circle(double radius, Color fillColor, Pen pen) {
        return new Circle(app, radius, fillColor, pen);
    }
     ...
     * @return the circle
     */
    public Image circle(double radius, String fillColor) {
        return new Circle(app, radius, color(fillColor), null);
    }
     ...
     * @return the circle
     */
    public Image circle(double radius, String fillColor, Pen pen) {
        return new Circle(app, radius, color(fillColor), pen);
    }
     ...
     * @return the circle
     */
    public Image circle(double radius, String fillColor, double opacity) {
        return new Circle(app, radius, color(fillColor, opacity), null);
    }
     ...
     * @return the circle
     */
    public Image circle(double radius, String fillColor, double opacity, Pen pen) {
        return new Circle(app, radius, color(fillColor, opacity), pen);
    }
     ...
     */
    public Image rectangle(double width, double height, String fillColor) {
        return new Rectangle(app, width, height, color(fillColor), null);
    }
     ...
     * @return the rectangle
     */
    public Image rectangle(double width, double height, String fillColor, double opacity) {
        return new Rectangle(app, width, height, color(fillColor, opacity), null);
    }
     ...
     * @return the rectangle
     */
    public Image rectangle(double width, double height, Pen pen) {
        return new Rectangle(app, width, height, null, pen);
    }
     ...
     * @return the rectangle
     */
    public Image rectangle(double width, double height, String fillColor, Pen pen) {
        return new Rectangle(app, width, height, color(fillColor), pen);
    }
     ...
     * @return the rectangle
     */
    public Image rectangle(double width, double height, String fillColor, double opacity, Pen pen) {
        return new Rectangle(app, width, height, color(fillColor, opacity), pen);
    }
     ...
     * @return the rectangle
     */
    public Image rectangle(double width, double height, Color fillColor) {
        return new Rectangle(app, width, height, fillColor, null);
    }
     ...
     * @return the rectangle
     */
    public Image rectangle(double width, double height, Color fillColor, Pen pen) {
        return new Rectangle(app, width, height, fillColor, pen);
    }
     ...
     * @return the square
     */
    public Image square(double width, Color fillColor) {
        return new Rectangle(app, width, width, fillColor, null);
    }
     ...
     * @return the square
     */
    public Image square(double width, Pen pen) {
        return new Rectangle(app, width, width, null, pen);
    }
     ...
     * @return the square
     */
    public Image square(double width, Color fillColor, Pen pen) {
        return new Rectangle(app, width, width, fillColor, pen);
    }
     ...
     * @return the square
     */
    public Image square(double width, String fillColor) {
        return new Rectangle(app, width, width, color(fillColor), null);
    }
     ...
     * @return the square
     */
    public Image square(double width, String fillColor, Pen pen) {
        return new Rectangle(app, width, width, color(fillColor), pen);
    }
     ...
     * @return the square
     */
    public Image square(double width, String fillColor, double opacity) {
        return new Rectangle(app, width, width, color(fillColor, opacity), null);
    }
     ...
     * @return the square
     */
    public Image square(double width, String fillColor, double opacity, Pen pen) {
        return new Rectangle(app, width, width, color(fillColor, opacity), pen);
    }
     ...
     * @return space image
     */
    public Image space(double width) {
        return new Rectangle(app, width, width, color("transparent"), null);
    }
     ...
     * @return space image
     */
    public Image space(double width, double height) {
        return new Rectangle(app, width, height, color("transparent"), null);
    }
     ...
     * @return the ellipse
     */
    public Image ellipse(double width, double height, Color fillColor) {
        return new Ellipse(app, width, height, fillColor, null);
    }
     ...
     * @return the ellipse
     */
    public Image ellipse(double width, double height, Pen pen) {
        return new Ellipse(app, width, height, null, pen);
    }
     ...
     * @return the ellipse
     */
    public Image ellipse(double width, double height, Color fillColor, Pen pen) {
        return new Ellipse(app, width, height, fillColor, pen);
    }
     ...
     * @return the ellipse
     */
    public Image ellipse(double width, double height, String fillColor) {
        return new Ellipse(app, width, height, color(fillColor), null);
    }
     ...
     * @return the ellipse
     */
    public Image ellipse(double width, double height, String fillColor, double opacity) {
        return new Ellipse(app, width, height, color(fillColor, opacity), null);
    }
     ...
     * @return the ellipse
     */
    public Image ellipse(double width, double height, String fillColor, Pen pen) {
        return new Ellipse(app, width, height, color(fillColor), pen);
    }
     ...
     * @return the ellipse
     */
    public Image ellipse(double width, double height, String fillColor, double opacity, Pen pen) {
        return new Ellipse(app, width, height, color(fillColor, opacity), pen);
    }
     ...
     * @return the line
     */
    public Image line(double x, double y, Color color) {
        return new Line(app, x, y, pen(color));
    }
     ...
     * @return the line
     */
    public Image line(double x, double y, String color) {
        return new Line(app, x, y, pen(color));
    }
     ...
     * @return the line
     */
    public Image line(double x, double y, Pen pen) {
        return new Line(app, x, y, pen);
    }
     ...
     * @return the line
     */
    public Image line(double x, double y, String color, double opacity) {
        return new Line(app, x, y, pen(color, opacity));
    }
     ...
     * @return the line
     */
    public Image line(Image image, double x1, double y1, double x2, double y2, Color color) {
        return new ImageLine(app, image, x1, y1, x2, y2, pen(color));
    }
     ...
     * @return the line
     */
    public Image line(Image image, double x1, double y1, double x2, double y2, Pen pen) {
        return new ImageLine(app, image, x1, y1, x2, y2, pen);
    }
     ...
     * @return the line
     */
    public Image line(Image image, double x1, double y1, double x2, double y2, String color) {
        return new ImageLine(app, image, x1, y1, x2, y2, pen(color));
    }
     ...
     * @return the line
     */
    public Image line(Image image, double x1, double y1, double x2, double y2, String color, double opacity) {
        return new ImageLine(app, image, x1, y1, x2, y2, pen(color, opacity));
    }
     ...
     * @return the line
     */
    public Image line(double x1, double y1, double x2, double y2, String color, Image image) {
        return new ImageLine(app, x1, y1, x2, y2, pen(color), image);
    }
     ...
     * @return the line
     */
    public Image line(double x1, double y1, double x2, double y2, String color, double opacity, Image image) {
        return new ImageLine(app, x1, y1, x2, y2, pen(color, opacity), image);
    }
     ...
     * @return the triangle
     */
    public Image triangle(double length, Color fillColor) {
        return new Triangle(app, length, fillColor, null);
    }
     ...
     * @return the triangle
     */
    public Image triangle(double length, Color fillColor, Pen pen) {
        return new Triangle(app, length, fillColor, pen);
    }
     ...
     * @return the triangle
     */
    public Image triangle(double length, Pen pen) {
        return new Triangle(app, length, null, pen);
    }
     ...
     * @return the triangle
     */
    public Image triangle(double length, String fillColor) {
        return new Triangle(app, length, color(fillColor), null);
    }
     ...
     * @return the triangle
     */
    public Image triangle(double length, String fillColor, Pen pen) {
        return new Triangle(app, length, color(fillColor), pen);
    }
     ...
     * @return the triangle
     */
    public Image triangle(double length, String fillColor, double opacity) {
        return new Triangle(app, length, color(fillColor, opacity), null);
    }
     ...
     * @return the triangle
     */
    public Image triangle(double length, String fillColor, double opacity, Pen pen) {
        return new Triangle(app, length, color(fillColor, opacity), pen);
    }
     ...
     * @return the triangle
     */
    public Image rightTriangle(double width, double height, String fillColor) {
        return new RightTriangle(app, width, height, color(fillColor), null);
    }
     ...
     * @return the triangle
     */
    public Image rightTriangle(double width, double height, Pen pen) {
        return new RightTriangle(app, width, height, null, pen);
    }
     ...
     * @return the triangle
     */
    public Image rightTriangle(double width, double height, String fillColor, Pen pen) {
        return new RightTriangle(app, width, height, color(fillColor), pen);
    }
     ...
     * @return the triangle
     */
    public Image rightTriangle(double width, double height, String fillColor, double opacity, Pen pen) {
        return new RightTriangle(app, width, height, color(fillColor, opacity), pen);
    }
     ...
     * @return the triangle
     */
    public Image isoscelesTriangle(double length, double alpha, String fillColor) {
        return new IsoscelesTriangle(app, length, alpha, color(fillColor), null);
    }
     ...
     * @return the triangle
     */
    public Image isoscelesTriangle(double length, double alpha, String fillColor, Pen pen) {
        return new IsoscelesTriangle(app, length, alpha, color(fillColor), pen);
    }
     ...
     * @return the triangle
     */
    public Image isoscelesTriangle(double length, double alpha, Color fillColor, Pen pen) {
        return new IsoscelesTriangle(app, length, alpha, fillColor, pen);
    }
     ...
     * @return the triangle
     */
    public Image isoscelesTriangle(double length, double alpha, Pen pen) {
        return new IsoscelesTriangle(app, length, alpha, null, pen);
    }
     ...
     * @return the star
     */
    public Image star(double radius, String fillColor) {
            return new Star(app, radius, color(fillColor), null);
    }
     ...
     * @return the star
     */
    public Image star(double radius, String fillColor, Pen pen) {
        return new Star(app, radius, color(fillColor), pen);
    }
     ...
     * @return the star
     */
    public Image star(double radius, Pen pen) {
        return new Star(app, radius, null, pen);
    }
     ...
     * @return the star
     */
    public Image star(double radius, int sides, int steps, String fillColor) {
        return new StarPolygon(app, radius, sides, steps, color(fillColor), null);
    }
     ...
     * @return the star
     */
    public Image star(double radius, int sides, int steps, String fillColor, Pen pen) {
        return new StarPolygon(app, radius, sides, steps, color(fillColor), pen);
    }
     ...
     * @return the star
     */
    public Image star(double radius, int sides, int steps, Pen pen) {
        return new StarPolygon(app, radius, sides, steps, null, pen);
    }
     ...
     * @return the star
     */
    public Image star(double radius, int sides, int steps, Color fillColor, Pen pen) {
        return new StarPolygon(app, radius, sides, steps, fillColor, pen);
    }
     ...
     * @return the star
     */
    public Image star(int spikes, double innerRadius, double outerRadius, String fillColor) {
        return new StarRadial(app, spikes, innerRadius, outerRadius, color(fillColor), null);
    }
     ...
     * @return the star
     */
    public Image star(int spikes, double innerRadius, double outerRadius, String fillColor, Pen pen) {
        return new StarRadial(app, spikes, innerRadius, outerRadius, color(fillColor), pen);
    }
     ...
     * @return the star
     */
    public Image star(int spikes, double innerRadius, double outerRadius, Color fillColor, Pen pen) {
        return new StarRadial(app, spikes, innerRadius, outerRadius, fillColor, pen);
    }
     ...
     * @return the star
     */
    public Image star(int spikes, double innerRadius, double outerRadius, Pen pen) {
        return new StarRadial(app, spikes, innerRadius, outerRadius, null, pen);
    }
     ...
     * @return the polygon
     */
    public Image polygon(double[] points, String fillColor, Pen pen) {
        return new Polygon(app, points, color(fillColor), pen);
    }
     ...
     * @return the polygon
     */
    public Image polygon(double[] points, Pen pen) {
        return new Polygon(app, points, null, pen);
    }
     ...
     * @return the polygon
     */
    public Image polygon(double[] points, String fillColor) {
        return new Polygon(app, points, color(fillColor), null);
    }
     ...
     * @return the polygon
     */
    public Image polygon(double[] points, String fillColor, double opacity, Pen pen) {
        return new Polygon(app, points, color(fillColor, opacity), pen);
    }
     ...
     * @return the polygon
     */
    public Image polygon(double[] points, String fillColor, double opacity) {
        return new Polygon(app, points, color(fillColor, opacity), null);
    }
     ...
     * @return the polygon
     */
    public Image polygon(Image image, double[] points, String fillColor) {
        return new ImagePolygon(app, image, points, color(fillColor), null);
    }
     ...
     * @return the polyline
     */
    public Image polyline(double[] points, String fillColor, Pen pen) {
            return new Polyline(app, points, color(fillColor), pen);
    }
     ...
     * @return the polyline
     */
    public Image polyline(double[] points, String fillColor) {
        return new Polyline(app, points, null, pen(fillColor));
    }
     ...
     * @return the polyline
     */
    public Image polyline(double[] points, Pen pen) {
        return new Polyline(app, points, null, pen);
    }
     ...
     * @return the polyline
     */
    public Image polyline(Image image, double[] points, String fillColor) {
        return new ImagePolyline(app, image, points, null, pen(fillColor));
    }
     ...
     * @return the text
     */
    public Image text(String string, double fontSize, String fillColor) {
        return new Text(app, string, fontSize, color(fillColor), null, 0, TextAlignment.LEFT);
    }

    public Image text(String string, double fontSize, Color fillColor) {
        return new Text(app, string, fontSize, fillColor, null, 0, TextAlignment.LEFT);
    }
     ...
     * @return the text
     */
    public Image text(String string, double fontSize, String fillColor, Pen pen) {
        return new Text(app, string, fontSize, color(fillColor), pen, 0, TextAlignment.LEFT);
    }
     ...
     * @return the text
     */
    public Image text(String string, double fontSize, Pen pen) {
        return new Text(app, string, fontSize, null, pen, 0, TextAlignment.LEFT);
    }
     ...
     * @return the text
     */
    public Image text(String string, String fontName, double fontSize, String fillColor) {
        return new Text(app, string, fontName, fontSize, color(fillColor), null, 0, TextAlignment.LEFT);
    }
     ...
     * @return the text
     */
    public Image text(String string, String fontName, double fontSize, String fillColor, Pen pen) {
        return new Text(app, string, fontName, fontSize, color(fillColor), pen, 0, TextAlignment.LEFT);
    }
     ...
     * @return the text
     */
    public Image text(String string, String fontName, double fontSize, Pen pen) {
        return new Text(app, string, fontName, fontSize, null, pen, 0, TextAlignment.LEFT);
    }
     ...
     * @return the text
     */
    public Image text(String string, Font font, Color fillColor, Pen pen) {
        return new Text(app, string, font, fillColor, pen, 0, TextAlignment.LEFT);
    }
    ...
    /**
     * Create pen of the given color, width, and stroke type. The following
     * stroke types are possible:
     * <ul>
     ...
     * <ul>
     * <li>StrokeLineCap.SQUARE (default: pen draws half its width beyond end of
     * unclosed shapes)
     ...
     * <li>StrokeLineJoin.BEVEL (joins outside corners of segments by straight
     * edges)
     * <li>StrokeLineJoin.ROUND (joins outside edges at a radius of half the pen
     * width)
     * </ul>
     *
     * @param color the color
...
//	 * Put the images next to each other, vertically centered w.r.t to each other:<br>
     ...
     * @return the result
     */
    public Image beside(Image... images) {
        return beside("center", images);
    }

    /**
     * {@code Image i = beside("top", circle(25, "red"), circle(12.5, "green"));}<br>
     * <img src="./doc-files/beside(top,circle(25,red),circle(12.5,green)).png" alt=""
     * ><br>
     * {@code Image i = beside("center", circle(25, "red"), circle(12.5, "green"));}<br>
     * <img src="./doc-files/beside(center,circle(25,red),circle(12.5,green)).png" alt=""
     * ><br>
     ...
     * @return the result
     */
    public Image beside(String align, Image... images) {
        Group g = new Group(app);
     ...
     */
    public Image beside(Image[] images, int start, int end) {
    ...
    /**
     * Put some of the images of an array next to each other using the given
     * alignment.
     *
     * @param align vertical alignment: top, middle, center, bottom
     * @param images the images to process
     ...
     * @return the images of the range next to each other
     */
    public Image beside(String align, Image[] images, int start, int end) {
        Image[] sub = new Image[end - start];
        System.arraycopy(images, start, sub, 0, end - start);
     ...
     * @return the result
     */
    public Image above(Image... images) {
        return above("center", images);
    }

    /**
     * {@code Image i = above("left", circle(25, "red"), circle(12.5, "green"));}<br>
     * <img src="./doc-files/above(left,circle(25,red),circle(12.5,green)).png" alt=""
     * ><br>
     * {@code Image i = above("center", circle(25, "red"), circle(12.5, "green"));}<br>
     * <img src="./doc-files/above(center,circle(25,red),circle(12.5,green)).png" alt=""
     * ><br>
     ...
     * @return the result
     */
    public Image above(String align, Image... images) {
        Group g = new Group(app);
        for (Image image : images) {
     ...
     */
    public Image above(Image[] images, int start, int end) {
        Image[] sub = new Image[end - start];
        System.arraycopy(images, start, sub, 0, end - start);
    ...
    /**
     * Put some of the images of an array above each other using the given
     * alignment.
     *
     * @param align horizontal alignment: left, middle, center, right
     * @param images the images to process
     ...
     * @return the images of the range above each other
     */
    public Image above(String align, Image[] images, int start, int end) {
        Image[] sub = new Image[end - start];
        System.arraycopy(images, start, sub, 0, end - start);
     ...
     */
    public Image overlay(Image... images) {
        return overlay("center", "center", images);
    }

    /**
     * {@code Image i = overlay("left", "top", circle(12.5, "green"), circle(25, "red"));}<br>
     * <img src="./doc-files/overlay(left,top,circle(12.5,green),circle(25,red)).png" alt=""
     * ><br>
     * {@code Image i = overlay("right", "center", circle(12.5, "green"), circle(25, "red"));}<br>
     * <img src="./doc-files/overlay(right,center,circle(12.5,green),circle(25,red)).png" alt=""
     * ><br>
     * {@code Image i = overlay("right", "bottom", circle(12.5, "green"), circle(25, "red"));}<br>
     * <img src="./doc-files/overlay(circle(right,bottom,12.5,green),circle(25,red)).png" alt=""
     * ><br>
     *
     ...
     * @return the overlaid images
     */
    public Image overlay(String xAlign, String yAlign, Image... images) {
        Group g = new Group(app);
     ...
     * @return the overlaid images
     */
    public Image overlay(double dx, double dy, Image... images) {
     ...
     * @return the overlaid images
     */
    public Image overlay(String xAlign, String yAlign, double dx, double dy, Image... images) {
        Group g = new Group(app);
        for (int i = images.length - 1; i >= 0; i--) {
            g.add(images[i], 0, 0);
        }
     ...
     * @return the overlaid images
     */
    public Image underlay(Image... images) {
     ...
     */
    public Image underlay(String xAlign, String yAlign, Image... images) {
        Group g = new Group(app);
        for (Image image : images) {
            g.add(image, 0, 0);
        }
     ...
     * @return the underlaid images
     */
    public Image underlay(double dx, double dy, Image... images) {
     ...
     * @return the underlaid images
     */
    public Image underlay(String xAlign, String yAlign, double dx, double dy, Image... images) {
        Group g = new Group(app);
        for (Image image : images) {
            g.add(image, 0, 0);
        }
     ...
     */
    public Image rotate(double angle, Image image) {
        return new Group(app, image, angle);
    }
     ...
     */
    public Image scale(double factor, Image image) {
     ...
     * @return the scaled image
     */
    public Image scale(double xFactor, double yFactor, Image image) {
        return new Group(app, image, xFactor, yFactor);
    }
     ...
     */
    public boolean save(Image i, String fileName) {
     ...
     * @return the grid
     */
    public Image grid(Image[][] images) {
     ...
     * @return the ellipse
     */
    public Image arc(double radius, double startAngle, double lengthAngle, String fillColor) {
        return new Arc(app, radius, startAngle, lengthAngle, color(fillColor), null);
    }
     ...
     * @return the ellipse
     */
    public Image arc(double radius, double startAngle, double lengthAngle, Pen pen) {
        return new Arc(app, radius, startAngle, lengthAngle, null, pen);
    }
     ...
     * @return the ellipse
     */
    public Image arc(double radius, double startAngle, double lengthAngle, String fillColor, Pen pen) {
        return new Arc(app, radius, startAngle, lengthAngle, color(fillColor), pen);
    }
     ...
     * @return the ellipse
     */
    public Image arc(double radius, double startAngle, double lengthAngle, String fillColor, double opacity, Pen pen) {
        return new Arc(app, radius, startAngle, lengthAngle, color(fillColor, opacity), pen);
    }
