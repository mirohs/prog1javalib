...
public class Group extends Image {
	...
	/**
	 * Create a rotation group (a group with a single child and the specified rotation).
	 * @param image the image to be rotated
	 * @param angle the rotation angle (in degrees, counterclockwise)
	 */
	public Group(Image image, double angle) { // todo: introduce class RotationGroup?
		super(0, 0);
	...
	/**
	 * Create a scale group (a group with a single child and the specified scaling).
	 * @param image the image to be scaled
	 * @param xFactor scaling in x-direction
	 * @param yFactor scaling in y-direction
	 */
	public Group(Image image, double xFactor, double yFactor) {
		super(0, 0);
		Child c = new Child(image, 0, 0);
