...
/**
 * Image is the base class of all graphics output. Images may be combined. Use
 * the static methods in {@link Graphics} to create images.
 *
 * @author michaelrohs
 */
...
//	public Image clip;
    ...
    /**
     * Returns the bounding box of this image under the given affine
     * transformation.
     *
     ...
     * @param pressFunctionTarget an arbitrary object that is used as an
     * argument when the press function is called
     */
     ...
     * @param releaseFunctionTarget an arbitrary object that is used as an
     * argument when the release function is called
     */
     ...
     * @param moveFunctionTarget an arbitrary object that is used as an argument
     ...
     * @param dragFunctionTarget an arbitrary object that is used as an argument
     * when the drag function is called
     */
